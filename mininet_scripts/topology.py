...
class Environment(object):
    def __init__(self):
        ...
        info("*** Adding links\n")  
        self.net.addLink(self.h1, self.cpe1, bw=100, delay='10ms')
        self.net.addLink(self.h2, self.cpe2, bw=100, delay='10ms')
        self.net.addLink(self.cpe1, self.core, bw=100, delay='10ms')
        self.net.addLink(self.cpe2, self.core, bw=100, delay='10ms')
        self.net.addLink(self.cpe4, self.core, bw=100, delay='10ms')
        self.net.addLink(self.cpe4, self.h3, bw=100, delay='10ms')
