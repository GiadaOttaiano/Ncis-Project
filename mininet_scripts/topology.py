...
class Environment(object):
    def __init__(self):
        ...
        self.net.addLink(self.cpe1, self.core1, bw=6, delay='0.0025ms')
        self.net.addLink(self.cpe2, self.core1, bw=6, delay='0.0025ms')
        self.net.addLink(self.cpe3, self.core1, bw=6, delay='0.0025ms')
        self.net.addLink(self.cpe3, self.h3,s bw=6, delay='0.0025ms')
